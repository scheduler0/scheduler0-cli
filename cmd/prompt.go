...
func runPrompt(cmd *cobra.Command, args []string) error {
	...
	fmt.Println("\nNote: These are job configurations generated by AI; nothing has been created. Use 'scheduler0 jobs create' to create jobs from them, or 'scheduler0 schedule' to have the server create them in one step.")
	return nil
}
